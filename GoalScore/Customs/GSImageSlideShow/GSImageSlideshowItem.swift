...
@objcMembers
open class GSImageSlideshowItem: UIScrollView, UIScrollViewDelegate {
    ...
    */
    init(image: InputSource, zoomEnabled: Bool, activityIndicator: ActivityIndicatorView? = nil, maximumScale: CGFloat = 2.0) {
        ...
        let tapRecognizer = UITapGestureRecognizer(target: self, action: #selector(GSImageSlideshowItem.tapZoom))
