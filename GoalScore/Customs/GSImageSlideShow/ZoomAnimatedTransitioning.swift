...
open class ZoomAnimatedTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {
    ...
    open weak var referenceSlideshowView: GSImageSlideshow?
     ...
     */
    public init(slideshowView: GSImageSlideshow, slideshowController: FullScreenSlideshowViewController) {
...
class ZoomAnimator: NSObject {
    ...
    var referenceSlideshowView: GSImageSlideshow?
    var parent: ZoomAnimatedTransitioningDelegate

    init(referenceSlideshowView: GSImageSlideshow, parent: ZoomAnimatedTransitioningDelegate) {
